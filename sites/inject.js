...
YNBrowser.ready(function() {
  ...
  // 目前屏蔽这个网站
  if (location.host.indexOf("m.58pic.com") !== -1) {
    //千图网文字乱码
    return;
  }
      ...
      switch (e.type) {
        case "touchstart": //500ms之后执行
          if (e.touches && e.touches.length == 1) {
            ...
            console.log("clear long press by " + e.type);
        ...
        default:
          if (
            ...
            if (
              ...
              console.log("clear long press by dist");
              clearTimeout(timeOutEvent);
            }
          } else {
            console.log("clear long press by " + e.type);
